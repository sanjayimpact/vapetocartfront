...
export const metadata = {
  title: "Terms and Conditions | Vape to Cart",
  description:
  ...
  alternates: {
    canonical: "https://www.vapetocart.co.uk/pages/terms",
  },
  robots: "index, follow",
  openGraph: {
    title: "Terms and Conditions | Vape to Cart",
    description:
      "From the North East of England, we aim to give you the ultimate choice, by stocking the most diverse range of e-liquids, at the best prices you'll find. Liquids to suit every budget and a huge range of hardware and accessories",
    url: "https://www.vapetocart.co.uk/pages/terms",
    type: "website",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Terms and Conditions | Vape to Cart",
      },
    ],
  },
  twitter: {
...
export default function TermPage() {
  const jsonLdWebsite = {
    ...
    "@type": "website",
    name: "Terms and Conditions | Vape to Cart",
    url: "https://www.vapetocart.co.uk/pages/terms",
    publisher: {
      "@type": "Organization",
      name: "Vape to Cart",
  ...
  const jsonLdBreadcrumb = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Terms",
        item: "https://www.vapetocart.co.uk/pages/terms",
      },
    ],
  };
    ...
    <>
      ...
      <section className="privacy sec-content sec-padding-small">
        <Container>
          <Row>
            <Col>
              <SectionHeadingCenter text="Terms of Service" />
              <p className="mb-2">
                This website is operated by Vape to Cart. Throughout the site,
                the terms “we”, “us” and “our” refer to Vape to Cart. Vape to
                Cart offers this website, including all information, tools and
              ...
              <p className="mb-2">
                Our store is hosted on Shopify. They provide us with the online
              ...
              <p className="mb-2">
                ...
                materials, products, or services of third-parties. We also use
                third-party cookies from Trustpilot.
              </p>
              <p className="mb-2">
              ...
              <p className="mb-2">
                ...
                example product suggestions) or without a request from us you
              ...
              <p className="mb-2">
                ...
                international, national or local regulations, rules, laws, or
                local ordinances; (d) to infringe upon or violate our
              ...
              <p className="mb-2">
                In no case shall Vape to Cart, our directors, officers,
              ...
              <p className="mb-2">
                lated in any way to your use of the service or any product,
              ...
              <p className="mb-2">
                You agree to indemnify, defend and hold harmless Vape to Cart
                ...
                any claim or demand, including reasonable legal fees, made by
              ...
              <h3 className="fs-4 color-dark my-3">SECTION 16 - TERMINATION</h3>
              <p className="mb-2">
              ...
              <p className="mb-2">
                ...
                or contemporaneous agreements, communication.
              </p>
              <p className="mb-2">
